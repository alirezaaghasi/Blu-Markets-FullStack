...
import type { Layer, TargetLayerPct } from '../types';
import { LAYERS } from '../constants/index';

interface DonutChartProps {
  layers: Partial<TargetLayerPct>;
  size?: number;
}
 ...
 */
function DonutChart({ layers, size = 160 }: DonutChartProps): React.ReactElement | null {
